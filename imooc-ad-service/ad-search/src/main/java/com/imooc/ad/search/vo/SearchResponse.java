...
public class SearchResponse {
    ...
    public Map<String,List<Creative>>  adSlotZAds = new HashMap<>();
    ...
    public static Creative conver(CreativeObject object){
        Creative creative = new Creative();
        creative.setAdId(object.getAdId());
        creative.setAdUrl(object.getAddUrl());
        creative.setWidth(object.getWidth());
        creative.setHeight(object.getHeight());
        creative.setMateriaType(object.getMaterialType());
